...
def home():
    adjetivos = [
        ...
        "Autêntica", "Engralada", "Sorridente", "Criativa", "Única",
        "Maravilhosa", "Doidinha", "Brilhante", "Determinada", "Cor de Papelão",
        "Radiante", "Sensível", "Corajosa", "Atenciosa", "Me Acha Gatinho:)",
        "Empática", "Sabe Conversar", "Bom Gosto Para Música", "Verdadeira", "Cativante",
        "Calma", "Sincera", "Sonhadora", "Persistente", "Amável",
        "Humilde", "Paciente", "Tem Um Cabelo Bonito", "Tem Uma Voz Encantadora", "Leve",
